...
import { useLoginFormik } from '../../Hooks/authentication.hooks'
...
function Login() {
    ...
    const formik = useLoginFormik() // Login formik

    // GSAP
    const loginLblRf = useRef()
    const loginFrmRf = useRef()
    gsap.registerPlugin( ScrollTrigger )
    // I need the same animation used in signup page 
    useGSAP( () => animateSignup( loginLblRf, loginFrmRf ), [] )
        ...
        <>
            ...
            <section id="login-root">
                ...
                <section id="login-left">
                    ...
                    <section ref={ loginLblRf }>

                        <p id='main-label'>AUTHENTICATE</p>
                        { isDesktop && <p>Are you new here? <span onClick={ () => navigate('/signup') }>Create an account!</span></p> }
                ...
                <section id="login-right">
                    ...
                    <form action="" ref={ loginFrmRf } onSubmit={ formik.handleSubmit }>
                        ...
                        { isMobile && 
                            ...
                            <p id='login-mobile-lable'>
                                
                                Are you new here? <span onClick={ () => navigate('/signup') }>Create an account!</span>
